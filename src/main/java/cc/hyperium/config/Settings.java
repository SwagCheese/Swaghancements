 ...
 */
@SuppressWarnings({"java:S1444", "java:S3008"}) // supress solarlint warnings about public static fields needing to be final and variables needing to be named according to the regular expression '^[a-z][a-zA-Z0-9]*$'
